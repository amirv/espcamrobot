...
int ledPin = 4;  // set digital pin GPIO4 as LED pin (use biult-in LED)
int buzzerPin = 2;  // set digital pin GPIO2 as LED pin (use Active Buzzer)
int servoPin = 2;  // set digital pin GPIO2 as servo pin (use SG90)
